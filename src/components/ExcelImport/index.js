...
class ExcelImport extends PureComponent {
  ...
  state = {
    ...
    isModalOpen: false,
    dict: [],
    portOrg: loginUser().rolesOrg != undefined ? loginUser().rolesOrg[0] : '',
  };
  ...
  drawOption = () => {
    ...
    let org = loginUser().rolesOrg != undefined ? loginUser().rolesOrg[0].split(',') : [];
   ...
   */
  next = () => {
    let orgList = loginUser().rolesOrg != undefined ? loginUser().rolesOrg[0].split(',') : '';
