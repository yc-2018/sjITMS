import {
    save, getByUuid, query, remove, audit, modify, auditInprogress, saveAndAudit, previousBill, nextBill,getByBillNumber
} from '@/services/rtn/VendorHandover';
import { message } from 'antd';

export default {
    namespace: 'vendorHandover',
    state: {
        data: {
            list: [],
            pagination: {}
    ...
    effects: {
      ...
      *getByBillNumber({ payload, callback }, { call, put }) {
        ...
        *auditInprogress({ payload, callback }, { call, put }) {
            const response = yield call(auditInprogress, payload);
            if (callback) callback(response);
        },
