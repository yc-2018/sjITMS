import {
    save, getByUuid, query, remove, audit, modify,getByBillNumber, auditInprogress, saveAndAudit,previousBill, nextBill
} from '@/services/rtn/RtnPutaway';
import { message } from 'antd';

export default {
    namespace: 'rtnPutaway',
    state: {
        data: {
            list: [],
            pagination: {}
