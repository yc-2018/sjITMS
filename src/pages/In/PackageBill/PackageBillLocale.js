...
export const orderLocale = {
  ...
  title: formatMessage({ id: 'packageBill.title' }),
  code: formatMessage({ id: 'packageBill.code' }),
  name: formatMessage({ id: 'packageBill.name' }),
  receiver: formatMessage({ id: 'packageBill.receiver' }),
  packageNumber: formatMessage({ id: 'packageBill.packageNumber' }),
  num: formatMessage({ id: 'packageBill.num' }),
  receiveContainerBarcode: formatMessage({ id: 'packageBill.receiveContainerBarcode' }),
  packageContainerBarcode: formatMessage({ id: 'packageBill.packageContainerBarcode' }),
  receiveOrNo: formatMessage({ id: 'packageBill.receiveOrNo' }),
  receivedCount: formatMessage({ id: 'packageBill.receivedCount' }),
  totalCount: formatMessage({ id: 'packageBill.totalCount' }),
}
