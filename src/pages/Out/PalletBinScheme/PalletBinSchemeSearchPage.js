...
import PalletBinSchemeSearchForm from './PalletBinSchemeSearchForm';
...
@Form.create()
export default class PalletBinSchemeSearchPage extends SearchPage {
  constructor(props) {
    super(props);
    this.state = {
      ...this.state,
      title: palletBinSchemeLocale.title,
      data: props.palletBinScheme.data,
      selectedRows: [],
      record: {},
      entityUuid: '',
      suspendLoading:false,
      key: 'palletBinScheme.search.table'
    }
  ...
  componentDidMount() {
    if(this.props.palletBinScheme.fromView) {
      return;
    } else {
      this.refreshTable();
    }
  ...
  componentWillReceiveProps(nextProps) {
    this.setState({
      data: nextProps.palletBinScheme.data
    });
  }
  ...
  */
  ...
  fetchOperateProps = (record) => {
    return [{
      ...
      confirm: true,
      confirmCaption: palletBinSchemeLocale.title,
  ...
  columns = [
    ...
    {
      title: palletBinSchemeLocale.palletBinType,
      dataIndex: 'palletBinType',
      sorter: true,
      width: colWidth.enumColWidth,
      render: (val, record) => record.palletBinType? convertCodeName(record.palletBinType) : undefined
    },
    {
