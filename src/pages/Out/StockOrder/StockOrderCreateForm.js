...
@Form.create()
class StockOrderCreateForm extends PureComponent {
  ...
  render() {
    ...
    let title = stockOrder ? stockOrderLocale.storeGroupUpdate : stockOrderLocale.storeGroupAdd;
...
export default StockOrderCreateForm;
