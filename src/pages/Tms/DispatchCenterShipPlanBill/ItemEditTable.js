    ...
    render() {
        ...
        return (
            <div id="editTable">
                ...
                <Table
                    rowSelection={this.props.noRowSelection?null:this.rowSelection}
                    rowKey={record => record.line}
                    columns={this.buildColumns()}
                    dataSource={data}
                    pagination={false}
                    scroll={this.props.scroll ? this.props.scroll : scroll}
                    size={this.props.tableSize?this.props.tableSize:'middle'}
                />
                {/* } */}
                {
                    this.props.batchAdd ? button : (this.props.noAddandDelete ? null : this.props.noAddButton? null :
                        button)
                }
                {
