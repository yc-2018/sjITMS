...
export default class DragSortingTable extends React.Component {
    ...
    return (
      ...
      >
        <Form>
          ...
          >
            <InputNumber autoFocus value={this.state.toAdjOrderNo} min={1} max={this.state.data ? this.state.data.length : 1} placeholder={placeholderLocale(SerialArchLocale.orderNo)} onChange={this.orderNoChange}
            />
          </FormItem>
        </Form>
      </Modal>
  ...
  render() {
    ...
    if (this.state.lineEntity.createOrg && loginOrg().uuid === this.state.lineEntity.createOrg.uuid) {
      columns.push(
        {
          key: 'operate',
          title: commonLocale.operateLocale,
          width: colWidth.operateColWidth+200,
          render: record => {
    ...
    let ret = (<div>
      <Tabs defaultActiveKey='1' tabBarExtraContent={
        this.state.lineEntity.createOrg && loginOrg().uuid === this.state.lineEntity.createOrg.uuid &&
        <Fragment>
...
// export default class DragSortingTableExport extends React.Component {
//   render() {
//     return (
//       <div>
