...
import { MemberType, Type, State } from '../../ShipPlanBillDispatch/ShipPlanBillDispatchContants';
    ...
    return <div>
      ...
      <div style={{ paddingLeft: '2%', paddingRight: '2%' }}>
        <ItemEditTable
          ...
          notNote={true}
          batchAdd
          noAddandDelete={entity.stat && entity.stat == State.Approved.name ? true : false}
          noRowSelection={entity.stat && entity.stat == State.Approved.name ? true : false}
