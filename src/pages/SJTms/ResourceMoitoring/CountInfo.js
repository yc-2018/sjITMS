...
import {
  ...
  getVehicleCount,
  getJobTodayCount,
  getTodayCompareOrder,
  getCollectbin,
} from '@/services/sjitms/ResourceMoitoring';
import { loginUser, loginOrg } from '@/utils/LoginContext';
import { getServicesByDept, getServicesByDc } from '@/services/sjitms/Customer';
import { havePermission } from '@/utils/authority';
import { routerRedux } from 'dva/router';

@connect(({ quick, loading }) => ({ quick, loading: loading.models.quick }))
export default class CountInfo extends PureComponent {
  ...
  getCustomer = async () => {
    ...
    if (response.success && response.data) {
      ...
      this.setState({ customerService: response.data });
    }
  };
  jumpCustomerDispose = () => {
    this.props.dispatch(
      routerRedux.push({
        pathname: '/tmscode/serviceDispose',
        payload: { showPage: 'view' },
      })
    );
  };
  ...
  render() {
    const bill_bl =
      loginOrg().uuid == '000000750000004' || loginOrg().uuid == '000008150000001'
        ? '码头'
        : '板位';
    const { orderCount, jobTodayCount, customerService } = this.state;
    return (
      <Layout style={{ backgroundColor: '#eef1f4', marginTop: -20 }}>
        ...
        >
          <div style={{ marginRight: 5 }}>
            <Button
              ...
              style={{ backgroundColor: '#ecf0f9  ', float: 'right' }}
          ...
          <div style={{ paddingTop: 5, height: 270 }}>
                  ...
                  <div>
                    <Row gutter={[16, 8]}>
                      ...
                      <Col
                        ...
                        span={6}
                        onClick={() => this.jumpCustomerDispose()}
                      >
                        <Card
                          title={'待处理工单'}
                          bordered={true}
            ...
            >
              ...
              <div style={{ height: 230, padding: 5 }} id="yunli" />
            </div>
            <div
              style={{
                width: '24.5%',
            ...
            >
              ...
              <div style={{ height: 230, padding: 5 }} id="bw" />
            </div>
          </div>
          ...
          >
            ...
            <Row gutter={[8, 8]}>
              <Col className="gutter-row" span={6}>
                ...
                >
                  <div id="bb" style={{ height: '90%' }} />
                  <div style={{ textAlign: 'center', fontWeight: 'bold', height: '10%' }}>
                    订单数
                  </div>
                </div>
              </Col>
