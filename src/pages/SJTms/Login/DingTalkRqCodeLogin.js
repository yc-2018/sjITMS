...
export default function DingTalkRqCodeLogin(dispatch) {
    function handleScriptLoad() {
        ...
        window.DTFrameLogin(
            ...
            async (loginResult) => {
                ...
                // 登录
               await dispatch({ type: 'login/dingLogin', payload: { authCode } });
            },
            (errorMsg) => {
                // 这里一般需要展示登录失败的具体原因
    ...
    function login() {
        const appid = "dingcklpj9ydkhrkwuxw";
        const redirect_uri = encodeURIComponent(`${window.location.origin}/user/dinglogin`);
    ...
    return <div className={styles.dingtalkLoginCell}>
        <Script
            url="https://g.alicdn.com/dingding/h5-dingtalk-login/0.21.0/ddlogin.js"
            onLoad={handleScriptLoad}
        />
        <div id='login_container' className={styles.dingtalkLoginContainer}></div>
