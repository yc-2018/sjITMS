...
export default class ItemBatchAddModal extends PureComponent{
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      articleUuid: props.articleUuid,
      container: props.fromContainerBarcode,
      wrhUuid: props.wrhUuid,
      ...
      if(nextProps.binCode) {
        this.props.dispatch({
          ...
          payload: {
            ...
            wrhUuid: nextProps.wrhUuid,
            binCode: nextProps.binCode,
            articleUuid: nextProps.articleUuid,
            containerBarcode: nextProps.fromContainerBarcode,
            state: 'NORMAL'
          },
          callback: response => {
            if (response && response.success) {
              this.setState({
                batchTableData: response.data
              })
            }
          }
        });
  ...
  columns=[
    {
      ...
      render:val=>{
        return <EllipsisCol colValue={convertArticleDocField(val)} />;
      }
    },
    {
