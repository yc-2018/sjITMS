...
/**
 * 搜索界面基类--嵌套子表格<br>
 * nestColumns 子表格的数据和列
 * data/columns 父表格的数据和列
 ...
 */
export default class NestSearchPage extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <PageHeaderWrapper>
                <Page scroll={scroll ? scroll : undefined}>
