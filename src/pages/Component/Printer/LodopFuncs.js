...
function getLodop(oOBJECT, oEMBED) {
  ...
  var strCLodopInstall_1 = "<br><font color='#FF00FF'>Web打印服务未安装启动，点击这里<a href='" + window.location.origin + "/CLodop_Setup_for_Win32NT.exe' target='_blank'>下载执行安装</a>";
  var strCLodopInstall_2 = "<br>（若此前已安装过，可<a href='CLodop.protocol:setup' target='_self'>点这里直接再次启动</a>）";
  var strCLodopInstall_3 = "，成功后请刷新本页面。</font><br>";
