...
class Monitorallcontent extends React.Component {
    constructor(props) {
      super(props);
    ...
    render() {
        ...
        return (
            ...
            <div className='monitorAllContent hidden' style={parentVisible} >
