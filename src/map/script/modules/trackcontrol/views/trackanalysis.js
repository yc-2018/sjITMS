...
class TrackAnalysis extends React.Component {
    componentDidUpdate() {
    ...
    drawAnalysisBehavior = (data) => {
        ...
        for (let i = 0;i < data.speeding.length; i++) {
            ...
            let loc_time = data.speeding[i][0].loc_time;
            if (starttime <= loc_time && loc_time <= endtime) {
