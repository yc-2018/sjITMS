export default {
  ...
  'form.phone-number.placeholder': '11位手機號',
  ...
  // 软件自定义
  'app.desc': '好看的倉庫前篇壹律，海鼎的系統百裏挑壹',
  'app.login.userName': '請輸入手機號',
  'app.login.user': '請輸入賬號',
  'app.login.password': '請輸入密碼',
  'app.login.change-captcha': '看不清，換一張',
  'validation.loginAccount.required': '登錄的手機號不能為空',
  'validation.password.required': '登錄密碼不能為空',
  'validation.user.required': '登錄賬號不能爲空',
  'validation.verification-code.required': '驗證碼不能爲空',
  ...
  'menu.compmgr': '企业管理',
  'menu.compmgr.role': '角色管理',
  'menu.compmgr.user': '用户管理',
  'menu.bigData': '大數據',
  'menu.notice': '通知',
  ...
  'menu.sjtms.basic.dispatchCenter': '調度中心',
  'menu.sjtms.basic.article': '商品',
  'menu.sjtms.basic.vehicle': '車輛',
  'menu.sjtms.basic.vehicleType': '車型',
  'menu.sjtms.basic.store': '門店',
  'menu.sjtms.basic.vendor': '供應商',
  'menu.sjtms.basic.employee': '員工',
  'menu.sjtms.basic.owner': '貨主',
  'menu.sjtms.basic.line': '綫路體系',
  'menu.sjtms.basic.lifecycle': '排車單生命周期控制',
  'menu.sjtms.core': '運輸管理',
  'menu.sjtms.core.order': '運輸訂單',
  'menu.sjtms.core.dispatch': '配送調度',
  'menu.sjtms.core.schedule': '排車單',
  'menu.sjtms.core.cardLoading': '刷卡裝車',
  'menu.sjtms.core.checkin': '出車回車登記',
  'menu.sjtms.core.confirm': '回車送貨確認',
  'menu.sjtms.core.takeConfirm': '提貨確認',
  'menu.sjtms.core.receipt': '對單回單',
  'menu.sjtms.core.return': '出車回車信息錄入',
  'menu.sjtms.core.taskCenter': '調度平臺',
};
