      ...
      },
      {
        ...
        routes: [
          ...
          },
          {
            ...
            quickuuid:'eff97b22-4e05-4daf-9bca-40ef711dc761',
            authority: ['iwms.basic.store'],
          },
          {
            path: '/test/quick2',
            name: 'quick2',
            component: './Quick/Quick',
            quickuuid:'a9123aa2-094a-4a6a-bc00-43729648986b',
            authority: ['iwms.basic.store'],
          },
          {
            path: '/test/quick3',
            name: 'quick3',
            component: './Quick/Quick',
            quickuuid:'ca7edf9e-6f7d-4158-9a38-d4b6849fe893',
            authority: ['iwms.basic.store'],
          },
          {
            path: '/test/quick6',
            ...
            quickuuid:'0f7d4e58-04ff-477b-93d2-5a41504bc4c2',
            authority: ['iwms.basic.store'],
          },
          {
            path: '/test/quick7',
            name: '白白白白白',
            component: './Quick/Quick',
            quickuuid:'9864ade5-56f9-4b96-981e-d0ecafc8fd75',
            authority: ['iwms.basic.store'],
          }
